...
const HomeScreen = () => {
    ...
    let { data, setData, loadFromStorage, saveToStorage } = useContext(DataContext)
                    ...
                    isVisibleCountryName == true ?
                        ...
                        text={'Devlet'}>
                                            ...
                                            <View style={{
                                                ...
                                                <HomeCard onPress={() => saveToStorage(data)}>
                                                ...
                                                <HomeCard onPress={() => EndTurn(data, setData, setLoading)}>
