        ...
        <ContentView>
            ...
            <ScrollView style={{
                ...
                <View style={{
                    ...
                    {/* <View>
                        <Text style={[styles.txtDarkBold, styles.txtCenter]}>Selected Country Focus</Text>
                        <Text style={[styles.txtDarkTitle, styles.txtCenter]}>{data.countryFocus == "attack" ? "%10 Attack Power" :
                            data.countryFocus == "defence" ? "%10 Defence Power"
                                : data.countryFocus == "pop" ? "%20 Population Growth"
                                    : data.countryFocus == "income" ? "%10 Income" :
                                        "%100 All Powers"}</Text>
                    </View> */}
                </View>
            </ScrollView>
